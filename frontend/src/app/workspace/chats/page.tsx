    ...
    <WorkspaceContainer>
      ...
      <WorkspaceBody>
        <div className="flex size-full flex-col">
          <h1 className="sr-only">{t.pages.chats}</h1>
          <header className="flex shrink-0 flex-col items-center gap-3 pt-8">
            <div className="flex w-full max-w-(--container-width-md) items-center gap-2">
              ...
              <Select value={agentFilter} onValueChange={setAgentFilter}>
                <SelectTrigger aria-label="Filter chats by agent" className="h-12 w-40 shrink-0">
                ...
                {filteredThreads?.map((thread) => {
                  ...
                  >
                    ...
                    <div className="flex shrink-0 items-center gap-2">
                      ...
                      <Button
                        aria-label={`${t.common.delete}: ${titleOfThread(thread)}`}
                        size="sm"
                        variant="ghost"
