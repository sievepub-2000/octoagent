          ...
          <div className="octo-panel space-y-5 rounded-2xl border p-6">
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between gap-3">
                <span className="text-sm font-medium">{t.agents.templateLabel}</span>
              ...
              <Select value={selectedTemplateKey} onValueChange={setSelectedTemplateKey}>
                <SelectTrigger data-testid="agent-template-select">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button variant="outline" size="sm" className="pointer-events-none h-9 shrink-0 text-xs">
