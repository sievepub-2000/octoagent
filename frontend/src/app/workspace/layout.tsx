...
import { SettingsPanel, type SettingsSectionId } from "@/components/workspace/settings";
        ...
        <SidebarInset className="min-w-0 flex flex-col">
          ...
          <div className="min-h-0 flex-1 overflow-hidden">
            <div className="flex h-full min-h-0">
              ...
              <SettingsPanel
                open={isSettingsSection}
                defaultSection={(isSettingsSection ? settingsSection : "appearance") as SettingsSectionId}
