  ...
  return (
    <div className="flex h-full flex-col overflow-y-auto p-6">
      ...
      {!mounted ? <div className="mb-4 h-9" /> : (
        <div aria-label="Skill category" className="mb-4 flex flex-wrap gap-2" role="group">
          {(["public", "custom"] as const).map((option) => (
            <Button
            ...
            >
              {option === "public" ? t.common.public : t.common.custom}
            </Button>
          ))}
        </div>
      )}
