...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_LOCAL_FRONTEND_PORT: z.string().optional(),
    NEXT_PUBLIC_LOCAL_GATEWAY_PORT: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_LOCAL_FRONTEND_PORT: process.env.NEXT_PUBLIC_LOCAL_FRONTEND_PORT,
    NEXT_PUBLIC_LOCAL_GATEWAY_PORT: process.env.NEXT_PUBLIC_LOCAL_GATEWAY_PORT,
    NEXT_PUBLIC_LOCAL_LANGGRAPH_PORT: process.env.NEXT_PUBLIC_LOCAL_LANGGRAPH_PORT,
