...
export function Hero({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <FlickeringGrid
        className="absolute inset-0 z-0 translate-y-8 mask-[url(/images/octopus.svg)] mask-size-[100vw] mask-center mask-no-repeat md:mask-size-[72vh]"
        squareSize={4}
        gridGap={4}
        color={"white"}
        maxOpacity={0.3}
