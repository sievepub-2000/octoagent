        ...
        <div className="flex flex-1 flex-col overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900/50">
          ...
          <div className="border-b border-zinc-800 p-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-zinc-400">OctoAgent Agent</span>
            </div>
          </div>
                ...
                >
                  ...
                  {[
                    ...
                    <div className="text-base text-zinc-300">
                      <span className="mr-2 inline-flex align-middle">✨</span>
                      Found 3 skills
                    </div>
                  )}
                  ...
                  {["load-deploy", "deploying", "done"].includes(phase) && (
                    ...
                    >
                      ...
                      {phase === "done" && (
                        ...
                        >
                          <div className="text-lg font-medium text-green-500">✅ Live at biotech-startup.vercel.app</div>
                        </motion.div>
                      )}
                    </motion.div>
                  )}
