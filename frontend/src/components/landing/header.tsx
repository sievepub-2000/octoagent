...
const REPOSITORY_URL = "https://github.com/sievepub-2000/octoagent";
const REPOSITORY_API_URL = "https://api.github.com/repos/sievepub-2000/octoagent";
    ...
    <header className="container-md fixed top-0 right-0 left-0 z-20 mx-auto flex h-16 items-center justify-between backdrop-blur-xs">
      <div className="flex items-center gap-2">
        <a href={REPOSITORY_URL} target="_blank" rel="noreferrer">
          <h1 className="font-serif text-xl">OctoAgent</h1>
        </a>
      </div>
