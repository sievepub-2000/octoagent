...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:ml-auto group-[.is-user]:rounded-[1.5rem] group-[.is-user]:border group-[.is-user]:border-border/40 group-[.is-user]:bg-[linear-gradient(180deg,var(--panel-start),var(--panel-end))] group-[.is-user]:px-4 group-[.is-user]:py-3 group-[.is-user]:text-foreground group-[.is-user]:shadow-[3px_3px_8px_var(--neu-dark),_-3px_-3px_8px_var(--neu-light)]",
      ...
      {isImage ? (
        ...
        <>
          <div
            ...
            className="bg-muted text-muted-foreground flex size-full shrink-0 items-center justify-center rounded-lg"
