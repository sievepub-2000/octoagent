...
지원되는 경우 upstream 계정에서 로그아웃하며 재사용 가능한 인터페이스 템플릿은 유지됩니다.`,
  ...
  taskGraph: {
    primaryAgent: "주 에이전트",
    subAgent: "보조 에이전트",
    doubleClickToEdit: "더블 클릭하여 작업 설명 편집",
  },

  // ChatLoading
  chatLoading: {
    title: "새 대화",
    preparing: "대화 작업 공간 준비 중...",
    inspectorLoading: "런타임 인스펙터 로딩 중",
  },
  ragSettings: {
    sectionTitle: "RAG 검색",
    ...
    downloadStart: "{model} 다운로드를 시작했습니다(몇 분 걸릴 수 있음)…",
    downloadDone: "{model} 다운로드 완료",
    embeddingTitle: "임베딩 모델 (Embedding)",
    modelLabel: "모델",
    cached: "캐시됨",
    ...
    configLocation: "구성 파일 위치:",
    reset: "재설정",
    saving: "저장 중…",
    save: "저장",
    modelLabelMiniLM: "MiniLM-L6 (영어, 384d, 88MB)",
    modelLabelBgeSmallZh: "BGE-small-zh (중국어, 512d, 184MB)",
    modelLabelBgeM3: "BGE-M3 (다국어, 1024d, 2.3GB)",
  },
  taskCardDetails: {
    resultDocument: "결과 문서",
    failureAnalysis: "실패 분석",
    loadCardDocFailed: "카드 문서를 불러오지 못했습니다",
    cardDocumentPreview: "카드 문서 미리보기",
    openDocument: "문서 열기",
  ...
  register: {
    ...
    needEmailVerify: "이 단말기는 이메일 인증이 필요합니다",
    loginFailed: "로그인에 실패했습니다",
    codeSentEmail: "인증 코드를 이메일로 전송했습니다",
    codeWrittenLog: "인증 코드를 서버 로그에 기록했습니다",
    registerFailed: "등록 요청에 실패했습니다",
    deviceVerifyFailed: "단말기 인증 요청에 실패했습니다",
    codeCheckFailed: "인증 코드 확인에 실패했습니다",
    title: "계정 및 단말기 인증",
    subtitleMail: "이메일 8자리 인증 코드(10분 유효)",
    subtitleFirst: "처음에는 사용자 이름과 비밀번호로 로그인",
    subtitleTrust: "이후에는 신뢰된 단말기 지문으로 입장",
    tabLogin: "로그인",
    tabRegister: "등록",
    username: "사용자 이름",
    password: "비밀번호",
    processing: "처리 중…",
    userPassLogin: "사용자 이름·비밀번호로 로그인",
    terminalLogin: "단말기 로그인",
    switchTerminal: "단말기 변경·이메일 인증",
    email: "이메일",
    displayName: "표시 이름(선택)",
    sending: "전송 중",
    sendCode: "인증 코드 전송",
    enter8Digit: "8자리 인증 코드 입력",
    verifyCode: "인증 코드",
    devCode: "개발 인증 코드:",
    verifying: "확인 중…",
    verifyAndEnter: "확인하고 입장",
  },
};
