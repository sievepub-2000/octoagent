...
export PYTHONPATH="$REPO_ROOT/backend/src:$REPO_ROOT/backend:${PYTHONPATH:-}"
export OCTOAGENT_APP_ROOT="${OCTOAGENT_APP_ROOT:-$REPO_ROOT}"
export OCTOAGENT_BACKEND_PATH="${OCTOAGENT_BACKEND_PATH:-$REPO_ROOT/backend}"
export OCTOAGENT_FILESYSTEM_ROOT="${OCTOAGENT_FILESYSTEM_ROOT:-$REPO_ROOT}"
export OCTOAGENT_MCP_TOOLS_DIR="${OCTOAGENT_MCP_TOOLS_DIR:-$REPO_ROOT/runtime/tools/mcp}"
...
export OCTOAGENT_MCP_REDIS_BIN="${OCTOAGENT_MCP_REDIS_BIN:-$OCTOAGENT_MCP_TOOLS_DIR/node_modules/.bin/mcp-server-redis}"
...
export OCTOAGENT_REDIS_URL="${OCTOAGENT_REDIS_URL:-redis://127.0.0.1:6379}"
export OCTOAGENT_GATEWAY_INTERNAL_URL="${OCTOAGENT_GATEWAY_INTERNAL_URL:-http://127.0.0.1:$GATEWAY_PORT}"
...
export OCTOAGENT_OPENROUTER_APP_URL="${OCTOAGENT_OPENROUTER_APP_URL:-https://github.com/sievepub-2000/octoagent}"
export OCTOAGENT_OPENROUTER_APP_TITLE="${OCTOAGENT_OPENROUTER_APP_TITLE:-OctoAgent}"
export OCTOAGENT_OPENROUTER_USAGE_INCLUDE="${OCTOAGENT_OPENROUTER_USAGE_INCLUDE:-true}"
export OCTOAGENT_KUBECONFIG_SMOKE="${OCTOAGENT_KUBECONFIG_SMOKE:-$REPO_ROOT/runtime/tools/kubernetes/kubeconfig-smoke.yaml}"
...
LANGGRAPH_N_JOBS_PER_WORKER="${OCTO_LANGGRAPH_N_JOBS_PER_WORKER:-2}"
LANGGRAPH_PID=""
