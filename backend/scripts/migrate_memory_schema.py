...
def migrate(memory_path: Path, *, dry_run: bool = False) -> int:
    ...
    print("[migrate-memory] original memory.json left untouched. The runtime normalizer bridges both shapes; flip to v2 by copying memory.v2.json over memory.json once you are comfortable.")
    return 0
