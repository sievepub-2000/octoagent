    ...
    modules = [
        _module(
            ...
            evidence=[
                ...
                _doctor_evidence(doctor, "workflow-langgraph-contract-smoke", manifest),
                _doctor_evidence(doctor, "runtime-provider-contract-api", manifest),
                staging_chat,
                chat_trend,
                soak_monitor,
            ],
        ...
        _module(
            ...
            evidence=[
                ...
                _path_evidence(
                    "operator_module_closure_smoke",
                    "backend/scripts/run_operator_module_closure_smoke.py",
                    "operator substrate closure smoke covers the operator module group",
                ),
                _doctor_evidence(doctor, "capability-policy-export-api", manifest),
                _doctor_evidence(doctor, "multi-tenant-api", manifest),
        ...
        _module(
            ...
            base=80,
            evidence=[
                _path_evidence("system_execution_governance", "backend/src/tools/system_execution/governance.py", "system execution governance module exists"),
                _path_evidence("system_execution_security_smoke", "backend/scripts/run_system_execution_security_smoke.py", "system execution operator auth smoke exists"),
                _path_evidence("release_precheck", "backend/scripts/run_release_precheck.py", "release precheck script exists"),
                _path_evidence("execution_worker_unit", "deploy/octoagent-execution-worker.service", "independent worker systemd unit exists"),
                _path_evidence("execution_worker_env", "deploy/system/execution-worker.env.example", "worker environment template exists"),
                rollback_drill,
            ],
            blockers=[] if rollback_drill.ok else ["production role mapping and rollback drills still require staging execution"],
            next_actions=[
                "Attach command policy presets to named deployment roles.",
                "Run rollback drill from the deployment runbook and archive the result.",
            ],
        ),
        _module(
            ...
            evidence=[
                ...
                _doctor_evidence(doctor, "query-engine-maintenance-api", manifest),
                _path_evidence("query_replay_golden", "backend/scripts/run_query_engine_replay_golden.py", "query replay golden smoke exists"),
        ...
        _module(
            ...
            evidence=[
                ...
                _path_evidence("worker_runbook", "project_docs/docs/EXECUTION_WORKER_DAEMON_RUNBOOK.md", "execution worker runbook exists"),
        ...
        _module(
            ...
            evidence=[
                ...
                _path_evidence("system_execution_security_gate", "backend/scripts/run_system_execution_security_smoke.py", "system execution auth smoke exists"),
                _path_evidence("operator_module_closure_gate", "backend/scripts/run_operator_module_closure_smoke.py", "operator substrate module closure smoke exists"),
