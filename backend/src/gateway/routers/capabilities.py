...
from src.capability_core import (
...
async def get_capability_inventory() -> CapabilityInventoryResponse:
    try:
        return CapabilityInventoryResponse.model_validate(
            get_capability_core_service().build_inventory()
        )
...
async def migrate_capabilities(request: CapabilityMigrationRequest) -> CapabilityMigrationResponse:
    try:
...
async def get_capability_runtime_state() -> CapabilityRuntimeStateResponse:
    try:
        return CapabilityRuntimeStateResponse.model_validate(
            get_capability_core_service().build_runtime_state()
        )
    except Exception as exc:
...
async def get_capability_audit() -> CapabilityAuditResponse:
    try:
        return CapabilityAuditResponse.model_validate(
            get_capability_core_service().build_audit_state()
        )
    except Exception as exc:
...
async def get_capability_registry() -> CapabilityRegistryResponse:
    try:
        return CapabilityRegistryResponse.model_validate(
            get_capability_core_service().build_registry_snapshot()
        )
    except Exception as exc:
...
async def get_capability_binding_contract() -> CapabilityBindingContractResponse:
    try:
        return CapabilityBindingContractResponse.model_validate(
            get_capability_core_service().build_binding_contract()
        )
    except Exception as exc:
...
async def get_capability_policies() -> CapabilityPolicyStateResponse:
    try:
        from src.capability_core import get_capability_policy_service

        return CapabilityPolicyStateResponse.model_validate(
            get_capability_policy_service().list_state()
        )
    except Exception as exc:
...
async def export_capability_policies() -> CapabilityPolicyExportResponse:
    try:
        from src.capability_core import get_capability_policy_service

        return CapabilityPolicyExportResponse.model_validate(
            get_capability_policy_service().export_state()
        )
    except Exception as exc:
...
async def import_capability_policies(request: CapabilityPolicyImportRequest) -> CapabilityPolicyStateResponse:
    try:
        from src.capability_core import get_capability_policy_service
...
async def get_capability_compat_preview() -> CapabilityCompatPreviewResponse:
    try:
        return CapabilityCompatPreviewResponse.model_validate(
            get_capability_core_service().build_agent_skills_compat_preview()
        )
    except Exception as exc:
...
async def invalidate_capability_cache() -> CacheInvalidateResponse:
