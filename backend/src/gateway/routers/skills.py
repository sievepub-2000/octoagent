...
from src.skills.agent_templates import (
...
async def update_skill(skill_name: str, request: SkillUpdateRequest) -> SkillResponse:
    ...
    try:
        ...
        update_metadata = (
            ...
            or request.license is not None
...
async def install_agency_agents() -> AgencyAgentsInstallResponse:
    try:
        ...
        await async_refresh_agent_tool_guide()
        message = (
            f"Installed '{skill_name}' with {template_count} agent templates from upstream Agency Agents"
        )
        logger.info(message)
