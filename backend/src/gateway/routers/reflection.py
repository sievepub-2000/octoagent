...
from src.reflection import get_reflection_service
...
async def record_observation(request: RecordObservationRequest) -> ObservationResponse:
    """Record a new execution observation."""
    from src.reflection.service import ExecutionObservation
...
async def derive_insights() -> InsightsListResponse:
