...
from src.storage.brain import BrainCoreService, BrainResponse, BrainTaskContext
from src.storage.brain.modules import BrainModuleDescriptor
...
class BrainCapabilitiesResponse(BaseModel):
    ...
    supported_modes: list[str] = Field(default_factory=lambda: ["plan", "research", "quant", "policy"])
