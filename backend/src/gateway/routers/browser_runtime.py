...
@router.get("/status", response_model=BrowserRuntimeStatusSnapshot)
async def get_browser_runtime_status() -> BrowserRuntimeStatusSnapshot:
    return get_browser_runtime_service().get_status_snapshot()
