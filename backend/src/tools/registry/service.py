...
class ToolRegistryService:
    ...
    def build_registry(self) -> ToolCapabilityRegistryResponse:
        ...
        active_subagents = int(raw_active_subagents) if isinstance(raw_active_subagents, (int, float)) else 0
        raw_retained_jobs = runtime_snapshot.get("retained_jobs", 0)
        retained_jobs = int(raw_retained_jobs) if isinstance(raw_retained_jobs, (int, float)) else 0
        ...
        runtime = ToolRegistryRuntime(
            ...
            max_total_subagent_jobs=subagent_config.max_total_subagent_jobs,
            retained_subagent_jobs=retained_jobs,
        )
