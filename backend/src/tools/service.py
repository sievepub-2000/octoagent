...
from .permissions import apply_runtime_permission_policy, dedupe_tools_by_name
...
class ToolService:
    ...
    def get_available_tools(
        ...
        *,
        ...
        tools = dedupe_tools_by_name(configured_tools + builtin_tools + mcp_tools)
        return apply_runtime_permission_policy(tools, permission_mode)
