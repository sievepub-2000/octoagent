...
class CheckpointerConfig(BaseModel):
    ...
    connection_string: str | None = Field(
        ...
        "For sqlite, use a file path like '.octoagent/checkpoints.db' or ':memory:' for in-memory. "
...
_checkpointer_config_explicit = False
...
def set_checkpointer_config(config: CheckpointerConfig | None) -> None:
    ...
    global _checkpointer_config, _checkpointer_config_explicit
    _checkpointer_config = config
    _checkpointer_config_explicit = True
...
def has_explicit_checkpointer_config() -> bool:
    """Return whether checkpointer config has been set explicitly in-process."""
    return _checkpointer_config_explicit
