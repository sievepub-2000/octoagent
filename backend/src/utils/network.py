...
class PortAllocator:
    ...
    Usage:
        ...
        port = allocator.allocate(start_port=19900)
        try:
            # Use the port...
        finally:
        ...
        with allocator.allocate_context(start_port=19900) as port:
            # Use the port...
    ...
    def allocate(self, start_port: int = 19900, max_range: int = 100) -> int:
    ...
    @contextmanager
    def allocate_context(self, start_port: int = 19900, max_range: int = 100):
...
def get_free_port(start_port: int = 19900, max_range: int = 100) -> int:
