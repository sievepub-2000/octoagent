...
MODULE_REGISTRY: dict[str, ModuleInfo] = {
    ...
    "orchestration": ModuleInfo(
        ...
        package="src.harness.orchestration",
    ...
    "system_execution": ModuleInfo(
        ...
        package="src.tools.system_execution",
        dependencies=("config",),
    ),
    "system_guard": ModuleInfo(
        ...
        package="src.runtime.system_guard",
        dependencies=("config",),
    ),
    "research_runtime": ModuleInfo(
        ...
        package="src.interfaces.research",
        dependencies=("config",),
    ),
    "browser_runtime": ModuleInfo(
        ...
        package="src.tools.sandbox.browser",
        dependencies=("config",),
    ),
    "session_compaction": ModuleInfo(
        ...
        package="src.storage.session_compaction",
        dependencies=("config",),
    ),
    "task_workspaces": ModuleInfo(
        ...
        package="src.storage.task_workspaces",
        dependencies=("config",),
    ),
    ...
    "skill_evolution": ModuleInfo(
        ...
        package="src.storage.skill_evolution",
    ...
    "interface_layer": ModuleInfo(
        ...
        package="src.interfaces.contracts",
        dependencies=("config",),
    ),
    # === SHARED LAYER ===
    "config": ModuleInfo(
    ...
    "reflection": ModuleInfo(
        ...
        package="src.harness.reflection",
    ),
    "utils": ModuleInfo(
        name="utils",
        layer=ModuleLayer.SHARED,
