...
def resolve_ml_intern_profile_name(
    ...
    *,
    ...
    explicit = normalize_profile_name(value or context.get("ml_intern_profile") or context.get("mlInternProfile") or context.get("ml_intern_mode") or context.get("mlInternMode"))
    if explicit:
        return explicit
    ...
    run_mode = normalize_profile_name(workflow_run_mode or workflow_mode or context.get("workflow_run_mode") or context.get("workflowRunMode") or context.get("mode"))
