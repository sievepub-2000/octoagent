...
class SandboxConfig(BaseModel):
    ...
    AioSandboxProvider specific options:
        ...
        port: Base port for sandbox containers (default: 19900)
        ...
        container_prefix: Prefix for container names (default: octoagent-sandbox)
    ...
    use: str = Field(
        ...,
        description="Class path of the sandbox provider (e.g. src.tools.sandbox.local:LocalSandboxProvider)",
    )
