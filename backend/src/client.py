...
from src.client_agent import ClientAgentBuilder
from src.client_streaming import ClientStreamSerializer
from src.config.app_config import get_app_config, reload_app_config
from src.config.extensions_config import ExtensionsConfig, McpServerConfig, SkillStateConfig, get_extensions_config, reload_extensions_config
...
class OctoAgentClient:
    ...
    def update_mcp_config(self, mcp_servers: dict[str, dict]) -> dict:
        ...
        current_config.mcp_servers = {
            name: McpServerConfig.model_validate(server)
