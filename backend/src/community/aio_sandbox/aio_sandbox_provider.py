...
DEFAULT_PORT = 19900
DEFAULT_CONTAINER_PREFIX = "octoagent-sandbox"
...
class AioSandboxProvider(SandboxProvider):
    ...
    Configuration options in config.yaml under sandbox:
        ...
        port: 19900                     # Base port for local containers
        container_prefix: octoagent-sandbox
    ...
    def _load_config(self) -> dict:
        ...
        return {
            ...
            # provisioner URL for dynamic pod management (e.g. http://provisioner:19888)
    ...
    def _get_thread_mounts(thread_id: str) -> list[tuple[str, str, bool]]:
        ...
        # host_paths resolves to the host-side base dir when OCTO_AGENT_HOST_BASE_DIR
    ...
    def _get_skills_mount() -> tuple[str, str, bool] | None:
        ...
        Mount source uses OCTO_AGENT_HOST_SKILLS_PATH when running inside Docker (DooD)
        ...
        try:
            ...
            if skills_path.exists():
                ...
                host_skills = os.environ.get("OCTO_AGENT_HOST_SKILLS_PATH") or str(skills_path)
