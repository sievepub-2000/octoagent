...
def _insight_to_trace(insight):
    ...
    from src.storage.skill_evolution.analyzer import ExecutionTrace
...
async def _on_task_event(event: str, payload: dict[str, Any]) -> None:
    ...
    try:
        from src.harness.reflection import ExecutionObservation, get_reflection_service
        ...
        from src.storage.skill_evolution.analyzer import SkillAnalyzer
