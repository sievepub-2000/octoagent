...
class ExecutionObservation:
    ...
    category: Literal["outcome", "performance", "error", "tool_usage", "model_quality"] = "outcome"
    summary: str = ""
...
class ReflectionInsight:
    ...
    category: Literal["skill_gap", "model_mismatch", "tool_failure", "prompt_quality", "efficiency"] = "efficiency"
    description: str = ""
