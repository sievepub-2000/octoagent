...
def _register_defaults(svc: InterfaceLayerService) -> None:
    ...
    # Browser runtime
    try:
        from src.tools.sandbox.browser import BrowserSessionRequest
    ...
    # Research runtime
    try:
        from src.interfaces.research import CreateResearchExperimentRequest
    ...
    # Plugins
    try:
        from src.tools.plugins import PluginInstallRequest
