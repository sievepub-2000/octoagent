        ...
        *,
        ...
        return {
            ...
            "builder": {
                ...
                "applied_action_ids": [item for item in builder_snapshot.get("applied_action_ids", []) if isinstance(item, str) and item.strip()] if isinstance(builder_snapshot.get("applied_action_ids"), list) else [],
            },
            "result": result or {},
        }
