...
def get_checkpointer() -> Checkpointer:
    ...
    from src.runtime.config.app_config import _app_config
    from src.runtime.config.checkpointer_config import get_checkpointer_config, has_explicit_checkpointer_config

    if _app_config is None and not has_explicit_checkpointer_config():
