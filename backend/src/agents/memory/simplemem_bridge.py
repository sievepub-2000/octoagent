...
class SimpleMemCompressor:
    ...
    def compress(
        ...
        *,
        ...
        # Split into windows
        windows = [
            messages[i : i + self.WINDOW_SIZE]
            for i in range(0, len(messages), self.WINDOW_SIZE)
        ]
...
def _extract_keywords(text: str) -> list[str]:
    ...
    stopwords = {
        ...
        "which", "they", "them", "their", "there", "been", "were", "about", "more",
        "also", "into", "some", "than", "your", "then", "would", "could", "should",
    }
