...
from src.ml_intern_defaults import build_ml_intern_prompt_section
...
def _get_memory_context(agent_name: str | None = None) -> str:
    ...
    try:
        ...
        memory_content = get_memory_layer_accessor().format_working_memory_context(
            agent_name,
...
Before using a managed capability category, call `read_file` on this guide and consult the relevant section first:
