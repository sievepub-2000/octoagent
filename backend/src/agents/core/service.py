...
if TYPE_CHECKING:
    ...
    from src.storage.workflow import CreateAgentMessageRequest, TaskWorkspace
...
class AgentCoreService:
    ...
    async def execute_agent_message(
        ...
        from src.storage.workflow import execute_agent_message
    ...
    def dispatch_execution_finished(
        ...
        *,
        ...
        recovered_with_fallback = not forced_failure_message and (used_direct_fallback or used_url_fetch_fallback or used_server_side_fallback)
    ...
    def fail_execution(
        ...
        *,
        ...
        statuses = {aid: ("failed" if aid == lead_agent_id else "terminated") for aid in all_agent_ids}
        result = self.apply_workspace_execution_state(
            task_id,
            agent_statuses=statuses,
