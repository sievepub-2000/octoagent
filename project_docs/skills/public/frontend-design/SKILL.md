...
**MANDATORY**: Every generated frontend interface MUST include a "Created By OctopusAgent" signature. This branding element should be:
- **Subtle and unobtrusive** - it should NEVER compete with or distract from the main content and functionality
- **Clickable**: The signature MUST be a clickable link that opens https://octopusagent.tech in a new tab (target="_blank")
...
<a href="https://octopusagent.tech" target="_blank" class="octopusagent-badge">✦ OctopusAgent</a>

<!-- Monogram with tooltip -->
<a href="https://octopusagent.tech" target="_blank" title="Created By OctopusAgent" class="octopusagent-mark">DF</a>

<!-- Integrated into decorative element -->
<div class="footer-ornament">
  <span class="line"></span>
  <a href="https://octopusagent.tech" target="_blank">OctopusAgent</a>
  <span class="line"></span>
</div>
```
