...
- user-editable global memory in `workspace/default/global_memory.json`
...
Operators should treat `workspace/runtime/system_memory.duckdb` as managed runtime data.
