...
This document provides a comprehensive overview of the OctopusAgent backend architecture.
...
|-------------|---------------|
| `/mnt/user-data/workspace` | `backend/.octopusagent/threads/{thread_id}/user-data/workspace` |
| `/mnt/user-data/uploads` | `backend/.octopusagent/threads/{thread_id}/user-data/uploads` |
| `/mnt/user-data/outputs` | `backend/.octopusagent/threads/{thread_id}/user-data/outputs` |
| `/mnt/skills` | `octopusagent/skills/` |
...
│ - ask_clarification │  │ - web_fetch         │  │ - filesystem        │
  (web_*: Tavily primary / DDG fallback; see CONFIGURATION.md)
...
2. Gateway receives file
   - Validates file
   - Stores in .octopusagent/threads/{thread_id}/user-data/uploads/
...
3. Returns response
   {
     "files": [{
       "filename": "doc.pdf",
       "path": ".octopusagent/.../uploads/doc.pdf",
