# Contributing to OctoAgent Backend

Thank you for your interest in contributing to OctoAgent! This document provides guidelines and instructions for contributing to the backend codebase.
...
2. Clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/octoagent.git
   cd octoagent
   ```
...
Thank you for contributing to OctoAgent!
