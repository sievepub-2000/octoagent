...
| **Community** | Tavily (web search), Jina AI (web fetch), DuckDuckGo (image search) |
...
- `OCTO_AGENT_CONFIG_PATH` - Override config.yaml location
- `OCTO_AGENT_EXTENSIONS_CONFIG_PATH` - Override extensions_config.json location
...
- **tavily-python** - Web search and scraping
