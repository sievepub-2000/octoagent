...
All bridge-backed examples assume the generic relay is running locally and OctoAgent is available at `http://127.0.0.1:19880`.
...
- Relay inbound URL: `http://127.0.0.1:30100/qq/inbound`
...
- Relay inbound URL: `http://127.0.0.1:30100/wechat/inbound`
...
- Relay inbound URL: `http://127.0.0.1:30100/line/inbound`
...
- Relay inbound URL: `http://127.0.0.1:30100/kakaotalk/inbound`
...
- Relay inbound URL: `http://127.0.0.1:30100/whatsapp/inbound`
...
- Relay inbound URL: `http://127.0.0.1:30100/zalo/inbound`
...
- Relay inbound URL: `http://127.0.0.1:30100/facebook_messenger/inbound`
...
If you still want a uniform relay fleet, forward normalized Telegram webhook or polling events to `http://127.0.0.1:30100/telegram/inbound` using the same payload shape.
...
```bash
curl -X POST http://127.0.0.1:30100/wechat/inbound \
