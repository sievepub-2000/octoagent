...
- `GET    /api/system-execution/capabilities` ← `system_execution.py`
- `GET    /api/system-execution/config` ← `system_execution.py`
- `GET    /api/system-execution/permission-policy` ← `system_execution.py`
- `GET    /api/system-execution/sessions` ← `system_execution.py`
- `GET    /api/system-execution/sessions/{session_id}` ← `system_execution.py`
- `GET    /api/system-execution/sessions/{session_id}/audit` ← `system_execution.py`
- `GET    /api/system-execution/sessions/{session_id}/snapshot` ← `system_execution.py`
- `POST   /api/system-execution/cli/system` ← `system_execution.py`
- `POST   /api/system-execution/cli/workspace` ← `system_execution.py`
- `POST   /api/system-execution/plan` ← `system_execution.py`
- `POST   /api/system-execution/sessions` ← `system_execution.py`
- `POST   /api/system-execution/sessions/live` ← `system_execution.py`
- `POST   /api/system-execution/sessions/{session_id}/execute-next` ← `system_execution.py`
- `POST   /api/system-execution/sessions/{session_id}/recover` ← `system_execution.py`
- `POST   /api/system-execution/sessions/{session_id}/status` ← `system_execution.py`
- `PUT    /api/system-execution/config` ← `system_execution.py`
