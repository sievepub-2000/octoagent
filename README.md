...
The only active OctoAgent project root on this host is `/home/sieve-pub/public-workspace/octoagent`. Archived or experimental worktree roots are not active project roots; branch and worktree content should be merged into the canonical project root.
